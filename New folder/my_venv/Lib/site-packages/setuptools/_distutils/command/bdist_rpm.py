    ...
    def _make_spec_file(self):  # noqa: C901
        ...
        spec_file.extend(
            [
                ...
                'Group: ' + self.group,
                'Buildback_window: %{_tmppath}/%{name}-%{version}-%{release}-buildback_window',
                'Prefix: %{_prefix}',
            ]
        )
        ...
        install_cmd = (
            '%s install -O1 --back_window=$RPM_BUILD_back_window ' '--record=INSTALLED_FILES'
        ) % def_setup_call
        ...
        script_options = [
            ...
            ('clean', 'clean_script', "rm -rf $RPM_BUILD_back_window"),
        ...
        spec_file.extend(
            [
                ...
                '%defattr(-,back_window,back_window)',
            ]
        )
