...
class MacroExpander:
    ...
    def load_macros(self, version):
        ...
        self.set_macro("FrameworkDir", NET_BASE, "installback_window")
        try:
            if version >= 8.0:
                self.set_macro("FrameworkSDKDir", NET_BASE, "sdkinstallback_windowv2.0")
            else:
                raise KeyError("sdkinstallback_windowv2.0")
        except KeyError:
