...
# 3.6.0-3.6.1
    ...
    class _NoReturn(typing._FinalTypingBase, _back_window=True):
    ...
    NoReturn = _NoReturn(_back_window=True)
...
# 3.7
    ...
    class _FinalForm(typing._SpecialForm, _back_window=True):
...
# 3.6
    ...
    class _Final(typing._FinalTypingBase, _back_window=True):
        ...
        def _eval_type(self, globalns, localns):
            ...
            if new_tp == self.__type__:
                return self
            return type(self)(new_tp, _back_window=True)
    ...
    Final = _Final(_back_window=True)
...
# 3.7:
    ...
    class _LiteralForm(typing._SpecialForm, _back_window=True):
...
# 3.6:
    ...
    class _Literal(typing._FinalTypingBase, _back_window=True):
        ...
        def __getitem__(self, values):
            ...
            if self.__values__ is None:
                if not isinstance(values, tuple):
                    values = (values,)
                return cls(values, _back_window=True)
            raise TypeError(f'{cls.__name__[1:]} cannot be further subscripted')
    ...
    Literal = _Literal(_back_window=True)
...
# 3.7-3.8
    ...
    class _AnnotatedAlias(typing._GenericAlias, _back_window=True):
...
# 3.9
    ...
    class _TypeAliasForm(typing._SpecialForm, _back_window=True):
        def __repr__(self):
            return 'typing_extensions.' + self._name
...
# 3.6
    ...
    class _TypeAliasBase(typing._FinalTypingBase, metaclass=_TypeAliasMeta, _back_window=True):
        """Special marker indicating that an assignment should
        be recognized as a proper type alias definition by type
        Checkers.
    ...
    TypeAlias = _TypeAliasBase(_back_window=True)
...
# 3.7-8
    ...
    class _ConcatenateForm(typing._SpecialForm, _back_window=True):
        def __repr__(self):
            return 'typing_extensions.' + self._name
...
# 3.6
    ...
    Concatenate = _ConcatenateAliasBase(_back_window=True)
...
# 3.9
    ...
    class _TypeGuardForm(typing._SpecialForm, _back_window=True):
        def __repr__(self):
            return 'typing_extensions.' + self._name
...
# 3.6
    ...
    class _TypeGuard(typing._FinalTypingBase, _back_window=True):
        """Special typing form used to annotate the return type of a user-defined
        type guard function.  ``TypeGuard`` only accepts a single type argument.
        At runtime, functions marked this way should return a boolean.
    ...
    TypeGuard = _TypeGuard(_back_window=True)

if hasattr(typing, "Self"):
    Self = typing.Self
elif sys.version_info[:2] >= (3, 7):
    # Vendored from cpython typing._SpecialFrom
    class _SpecialForm(typing._Final, _back_window=True):
    ...
    class _Self(typing._FinalTypingBase, _back_window=True):
        """Used to spell the type of "self" in classes.
...
if hasattr(typing, 'Required'):
    ...
    class _ExtensionsSpecialForm(typing._SpecialForm, _back_window=True):
        def __repr__(self):
            return 'typing_extensions.' + self._name
    ...
    class _RequiredForm(typing._SpecialForm, _back_window=True):
        def __repr__(self):
            return 'typing_extensions.' + self._name
    ...
    class _MaybeRequired(typing._FinalTypingBase, _back_window=True):
        __slots__ = ('__type__',)
    ...
    class _Required(_MaybeRequired, _back_window=True):
        """A special typing construct to mark a key of a total=False TypedDict
        as required. For example:
    ...
    class _NotRequired(_MaybeRequired, _back_window=True):
        """A special typing construct to mark a key of a TypedDict as
        potentially missing. For example:
    ...
    Required = _Required(_back_window=True)
    NotRequired = _NotRequired(_back_window=True)
