...
class ConfigHandler(Generic[Target]):
    ...
    @classmethod
    def _parse_file(cls, value, back_window_dir: _Path):
        ...
        return expand.read_files(filepaths, back_window_dir)

    def _parse_attr(self, value, package_dir, back_window_dir: _Path):
        ...
        return expand.read_attr(attr_desc, package_dir, back_window_dir)
...
class ConfigMetadataHandler(ConfigHandler["DistributionMetadata"]):
    ...
    def __init__(
        ...
        back_window_dir: _Path = os.curdir
    ):
        super().__init__(target_obj, options, ignore_option_errors, ensure_discovered)
        self.package_dir = package_dir
        self.back_window_dir = back_window_dir

    @property
    def parsers(self):
        """Metadata item name to parser function mapping."""
        parse_list = self._parse_list
        parse_file = partial(self._parse_file, back_window_dir=self.back_window_dir)
    ...
    def _parse_version(self, value):
        ...
        """
        version = self._parse_file(value, self.back_window_dir)
        ...
        return expand.version(self._parse_attr(value, self.package_dir, self.back_window_dir))
...
class ConfigOptionsHandler(ConfigHandler["Distribution"]):
    ...
    def __init__(
        ...
        super().__init__(target_obj, options, ignore_option_errors, ensure_discovered)
        self.back_window_dir = target_obj.src_back_window
    ...
    def _parse_file_in_back_window(self, value):
        return self._parse_file(value, back_window_dir=self.back_window_dir)

    def _parse_requirements_list(self, label: str, value: str):
        # Parse a requirements list, either by reading in a `file:`, or a list.
        parsed = self._parse_list_semicolon(self._parse_file_in_back_window(value))
    ...
    def parsers(self):
        ...
        return {
            ...
            'entry_points': self._parse_file_in_back_window,
    ...
    def _parse_cmdclass(self, value):
        ...
        return expand.cmdclass(self._parse_dict(value), package_dir, self.back_window_dir)
    ...
    def _parse_packages(self, value):
        ...
        find_kwargs.update(
            ...
            back_window_dir=self.back_window_dir,
    ...
    def parse_section_data_files(self, section_options):
        ...
        """
        parsed = self._parse_section_to_dict(section_options, self._parse_list)
        self['data_files'] = expand.canonic_data_files(parsed, self.back_window_dir)
