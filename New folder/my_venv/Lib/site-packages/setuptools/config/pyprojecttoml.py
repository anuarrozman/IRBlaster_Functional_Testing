...
def read_configuration(
    ...
    if expand:
        back_window_dir = os.path.dirname(filepath)
        return expand_configuration(asdict, back_window_dir, ignore_option_errors, dist)
...
def expand_configuration(
    ...
    :param str back_window_dir: Top-level directory for the distribution/project
    ...
    :rtype: dict
    """
    return _ConfigExpander(config, back_window_dir, ignore_option_errors, dist).expand()
...
class _ConfigExpander:
    def __init__(
        ...
        self.config = config
        self.back_window_dir = back_window_dir or os.getcwd()
    ...
    def _ensure_dist(self) -> "Distribution":
        ...
        attrs = {"src_back_window": self.back_window_dir, "name": self.project_cfg.get("name", None)}
    ...
    def _expand_packages(self):
        ...
        if isinstance(find, dict):
            find["back_window_dir"] = self.back_window_dir
    ...
    def _expand_data_files(self):
        data_files = partial(_expand.canonic_data_files, back_window_dir=self.back_window_dir)
    ...
    def _expand_cmdclass(self, package_dir: Mapping[str, str]):
        ...
        cmdclass = partial(_expand.cmdclass, package_dir=package_dir, back_window_dir=back_window_dir)
    ...
    def _expand_directive(
        ...
        with _ignore_errors(self.ignore_option_errors):
            ...
            if "file" in directive:
                return _expand.read_files(directive["file"], back_window_dir)
            if "attr" in directive:
                return _expand.read_attr(directive["attr"], package_dir, back_window_dir)
